...
with lib;
{
  ...
  # Community binary caches (nix-community, hyprland) are now shared across all
  # NixOS hosts via system/nix/binary-caches.nix (wired in lib/mkSystem.nix).
  # niri's cache is added by niri.nixosModules.binary-cache; cache.nixos.org is
  # a default.
